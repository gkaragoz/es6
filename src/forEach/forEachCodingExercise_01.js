...
// but it is doing so using a for loop.
// This implementation works,
// but the for loop makes it more challenging
...
function handlePostsRefactored() {
  let posts = [
    { id: 23, title: "Daily JS News" },
    { id: 52, title: "Daily JS News" },
    { id: 105, title: "Daily JS News" },
  ];
